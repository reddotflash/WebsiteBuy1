...
for i = 1, 10 do
    MainTab:CreateToggle({
        ...
        CurrentValue = false,
        Callback = function(Value)
            if i == 1 then if Value then esp() end -- Calls your 1.3k line block -- Toggle 1 Logic
...
-- ==========================================================
-- SETTINGS TAB: DYNAMIC THEME PICKER
-- ==========================================================
SettingsTab:CreateSection("Theme Settings")

SettingsTab:CreateColorPicker({
    Name = "UI Theme Color",
    Color = Color3.fromRGB(150, 150, 150), -- Starting color
    Callback = function(Value)
        -- Update the core Rayfield theme properties
        Rayfield.Theme.Background = Value
        Rayfield.Theme.HeaderColor = Value
        Rayfield.Theme.ElementColor = Value
        Rayfield.Theme.TextColor = Color3.fromRGB(255, 255, 255) -- Keeps text white
        
        -- Optional: Save this as a global so other parts of your script can use it
        _G.EgoHubTheme = Value
        
        Rayfield:Notify({
            Title = "Theme Changed",
            Content = "The UI color has been updated!",
            Duration = 3,
        })
    end
})
